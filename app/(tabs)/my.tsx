    ...
    >
      <View className="flex-row items-center flex-1">
        ...
        <View className="flex-1">
          <Text className="text-base font-medium text-gray-800 mb-0.5">
            {item.title}
          </Text>
      ...
      >
          ...
          <View className="flex-row items-center">
            ...
            <View className="flex-1">
              ...
              <View className="flex-row items-center mb-1">
                <Text className="text-sm text-white opacity-90 mr-2">
                  Lv.5 探索者
                </Text>
        ...
        <View className="flex-row justify-between">
          {userStats.map((stat, index) => (
            <View
              key={index}
              className="bg-white bg-opacity-90 rounded-xl p-3 items-center flex-1 mx-0.5"
            >
